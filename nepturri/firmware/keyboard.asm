...
l51: # 
	...
	st	r0
						...
						//..//firmware/keyboard.c, line 102
						//pcreltotemp
	.lipcrel	l52
	add	r7
l38: # 

						//..//firmware/keyboard.c, line 111
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 1 type 3
						// const
	.liconst	240
	...
	st	r0
						...
						//..//firmware/keyboard.c, line 115
						//pcreltotemp
	.lipcrel	l42
	add	r7
l41: # 

						//..//firmware/keyboard.c, line 116
						// (test)
						// (obj to tmp) flags 2 type 3
						//static not varadr
						//statictotemp (FIXME - make PC-relative?)
