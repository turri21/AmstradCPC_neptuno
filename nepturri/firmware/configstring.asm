...
_configstring_next:
	stdec	r6
						...
						//..//firmware/configstring.c, line 30
		// Offsets 255, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
_configstring_begin:
	stdec	r6
						...
						//..//firmware/configstring.c, line 44
		// Offsets 255, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//..//firmware/configstring.c, line 45
		// Offsets 545, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//..//firmware/configstring.c, line 46
		// Offsets 20, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
_configstring_end:
	stdec	r6
						...
						//..//firmware/configstring.c, line 52
		// Offsets 32, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
l13: # 
						...
						//..//firmware/configstring.c, line 60
						//call
						//pcreltotemp
	...
	mr	r1
						...
						//..//firmware/configstring.c, line 61
						// (test)
...
l14: # 
						...
						//..//firmware/configstring.c, line 62
						// Q1 disposable
						//setreturn
...
_configstring_copytocomma:
	...
	mr	r3
						...
						//..//firmware/configstring.c, line 74
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
	...
	mr	r4
						...
						//..//firmware/configstring.c, line 76
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	mr	r1
						...
						//..//firmware/configstring.c, line 77
						// (test)
						// (obj to tmp) flags 42 type 3
						// matchobj comparing flags 42 with 42
						// reg r1 - only match against tmp
...
l34: # 
						...
						//..//firmware/configstring.c, line 79
						// (compare) (q1 signed) (q2 signed)
	...
	.lipcrel	l23
		add	r7
						...
						//..//firmware/configstring.c, line 80
						//FIXME convert
...
l23: # 
						...
						//..//firmware/configstring.c, line 81
						// (test)
						// (obj to tmp) flags 42 type 3
						// reg r1 - only match against tmp
	mt	r1
	...
	.lipcrel	l26
		add	r7
						...
						//..//firmware/configstring.c, line 82
...
l26: # 
						...
						//..//firmware/configstring.c, line 83
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
...
l35: # 
						...
						//..//firmware/configstring.c, line 85
						// (test)
						// (obj to tmp) flags 2 type 3
						// var, auto|reg
	.liconst	16
	...
	.lipcrel	l30
		add	r7
						...
						//..//firmware/configstring.c, line 86
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 6a
						// (a/p assign)
...
l30: # 
						...
						//..//firmware/configstring.c, line 87
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 1 type 3
						// const
	.liconst	44
...
_configstring_getdigit:
	stdec	r6
						...
						//..//firmware/configstring.c, line 93
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	mr	r1
						...
						//..//firmware/configstring.c, line 95
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 42
						// const
	...
	.lipcrel	l39
		add	r7
						...
						//..//firmware/configstring.c, line 96
...
l39: # 
						...
						//..//firmware/configstring.c, line 97
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 1 type 3
						// const
	.liconst	65
	...
	.lipcrel	l42
		add	r7
						...
						//..//firmware/configstring.c, line 98
						// (bitwise/arithmetic) 	//ops: 2, 0, 2
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 1
...
l42: # 
						...
						//..//firmware/configstring.c, line 103
						// Q1 disposable
						//setreturn
						// (obj to r0) flags 42 type 3
						// reg r1 - only match against tmp
...
_configstring_getcorename:
	...
	mr	r4
						...
						//..//firmware/configstring.c, line 112
						//call
						//pcreltotemp
	...
	add	r7
						...
						//..//firmware/configstring.c, line 113
						// (a/p push)
	...
	mr	r3
						...
						//..//firmware/configstring.c, line 114
						//call
						//pcreltotemp
	...
	add	r7
						...
						//..//firmware/configstring.c, line 115
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 1 type 3
						// const
	.liconst	0
	...
	.lipcrel	l47
		add	r7
						...
						//..//firmware/configstring.c, line 116
						// (minus)
...
l47: # 
						...
						//..//firmware/configstring.c, line 117
						// (compare) (q1 signed) (q2 signed)
						// (obj to tmp) flags 2 type 3
						// var, auto|reg
	.liconst	12
...
l51: # 
						...
						//..//firmware/configstring.c, line 118
...
l52: # 
						...
						//..//firmware/configstring.c, line 119
						// Q1 disposable
						// Q2 disposable
						// (bitwise/arithmetic) 	//ops: 5, 4, 2
						//Special case - addt
...
_configstring_setindex:
	...
	mr	r2
						...
						//..//firmware/configstring.c, line 127
		// Offsets -44, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
	...
	mr	r4
						...
						//..//firmware/configstring.c, line 132
		// Offsets 0, 0
		// Have am? no, no
		// flags 42, 4a
						// (a/p assign)
	...
	mr	r3
						...
						//..//firmware/configstring.c, line 134
						// (test)
						// (obj to tmp) flags 42 type 3
						// matchobj comparing flags 42 with 42
						// reg r3 - only match against tmp
	...
	.lipcrel	l56
		add	r7
						...
						//..//firmware/configstring.c, line 135
						// (bitwise/arithmetic) 	//ops: 4, 0, 4
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 42
...
l56: # 
						...
						//..//firmware/configstring.c, line 139
		// Offsets 517, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//..//firmware/configstring.c, line 140
						// Q1 disposable
						//setreturn
						// (obj to r0) flags 42 type 3
						// matchobj comparing flags 42 with 1
...
_configstring_matchextension:
	...
	mr	r3
						...
						//..//firmware/configstring.c, line 146
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 62
						// (a/p assign)
	...
	st	r6
						...
						//..//firmware/configstring.c, line 152
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r1)
	...
	.lipcrel	l60
		add	r7
						...
						//..//firmware/configstring.c, line 154
						// (bitwise/arithmetic) 	//ops: 4, 0, 2
						//Special case - addt
						// (prepobj r0)
 						// reg r1 - no need to prep
	...
	.lipcrel	l62
		add	r7
						...
						//..//firmware/configstring.c, line 155
						//setreturn
	...
	mr	r0
						...
						//..//firmware/configstring.c, line 156
						//pcreltotemp
	.lipcrel	l57
	add	r7
l62: # 
	...
	mr	r0
						...
						//..//firmware/configstring.c, line 157
						//pcreltotemp
	.lipcrel	l57
	add	r7
						// freereg r1
l60: # 
						...
						//..//firmware/configstring.c, line 167
						//call
						//pcreltotemp
	.lipcrel	_configstring_begin // extern
	add	r7
						...
						//..//firmware/configstring.c, line 177
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
	...
	mr	r4
						...
						//..//firmware/configstring.c, line 178
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r1)
...
l92: # 
						...
						//..//firmware/configstring.c, line 182
						// (test)
						// (obj to tmp) flags 2 type 101
						// extern
	.liabs	_configstring_index
...
l90: # 
						...
						//..//firmware/configstring.c, line 186
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	mr	r1
						...
						//..//firmware/configstring.c, line 188
						// (test)
						// (obj to tmp) flags 42 type 3
						// matchobj comparing flags 42 with 42
						// reg r1 - only match against tmp
...
l93: # 
						...
						//..//firmware/configstring.c, line 191
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
...
l91: # 
						...
						//..//firmware/configstring.c, line 195
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	mr	r5
						...
						//..//firmware/configstring.c, line 196
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	stmpdec	r0
						...
						//..//firmware/configstring.c, line 197
						//call
						//pcreltotemp
	.lipcrel	_configstring_next // extern
	add	r7
	...
	mr	r2
						...
						//..//firmware/configstring.c, line 199
						// (bitwise/arithmetic) 	//ops: 5, 0, 5
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 103
						// matchobj comparing flags 1 with 42
	...
	add	r4
						...
						//..//firmware/configstring.c, line 200
						// (bitwise/arithmetic) 	//ops: 4, 0, 2
						//Special case - addt
						// (prepobj r0)
 						// reg r1 - no need to prep
...
l78: # 
						...
						//..//firmware/configstring.c, line 201
		// Offsets 1, 0
		// Have am? no, no
		// flags 1, 62
						// (a/p assign)
	...
	st	r6
						...
						//..//firmware/configstring.c, line 202
						//pcreltotemp
	.lipcrel	l87
	add	r7
l79: # 
...
l86: # 
						...
						//..//firmware/configstring.c, line 204
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
	...
	mr	r4
						...
						//..//firmware/configstring.c, line 205
		// Offsets 1, 0
		// Have am? no, no
		// flags 1, 62
						// (a/p assign)
...
l87: # 
						...
						//..//firmware/configstring.c, line 193
						// (test)
	...
	.lipcrel	l91
		add	r7
						...
						//..//firmware/configstring.c, line 208
						//call
						//pcreltotemp
	.lipcrel	_configstring_end // extern
	add	r7
						...
						//..//firmware/configstring.c, line 210
						// Q1 disposable
						//FIXME convert
