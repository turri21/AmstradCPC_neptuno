...
l13: # 
	...
	mr	r2
						...
						//..//firmware/romimg.c, line 67
						//pcreltotemp
	.lipcrel	l16
	add	r7
l15: # 

						//..//firmware/romimg.c, line 68
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 82 type a
						// (prepobj tmp)
...
l27: # 
	...
	mr	r0
						...
						//..//firmware/romimg.c, line 86
						//pcreltotemp
	.lipcrel	l22
	add	r7
l4: # 

						//..//firmware/romimg.c, line 88
						//setreturn
						// (obj to r0) flags 1 type 3
						// const
	.liconst	0
...
l32: # 
	...
	add	r7
						...
						//..//firmware/romimg.c, line 104
						//pcreltotemp
	.lipcrel	l29
	add	r7
l33: # 

						//..//firmware/romimg.c, line 119
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 42 type 3
						// reg r4 - only match against tmp
