...
l11: # 
	...
	mr	r4
		...
		// flags 4a, 4a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 65
		// Real offset of type is 65, isauto 0
						// (prepobj r0)
 						// reg r3 - no need to prep
	...
	mr	r2
		...
		// flags 1, 4a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 73
	...
	stbinc	r0
						...
						//..//firmware/diskimg.c, line 47
		// Offsets 14, 17
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 17, 0
	...
	stbinc	r0
						...
						//..//firmware/diskimg.c, line 48
		// Offsets 50, 19
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 19, 0
		// Real offset of type is 19, isauto 0
						// (prepobj r0)
 						// (prepobj r0)
 						// matchobj comparing flags 82 with 1
						// matchobj comparing flags 82 with 82
						//auto: flags: 82, comparing 0, 19 with 0, 18
	...
	stbinc	r0
						...
						//..//firmware/diskimg.c, line 50
		// Offsets 89, 21
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 21, 0
	...
	stbinc	r0
						...
						//..//firmware/diskimg.c, line 51
		// Offsets 144, 22
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 22, 0
	...
	stmpdec	r1
						...
						//..//firmware/diskimg.c, line 55
		// Offsets 95, 26
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 26, 0
		// Real offset of type is 26, isauto 0
						// (prepobj r0)
 						// (prepobj r0)
 						// matchobj comparing flags 82 with 82
						//auto: flags: 82, comparing 0, 26 with 0, 25
	...
	stbinc	r0
						...
						//..//firmware/diskimg.c, line 56
		// Offsets 192, 27
		// Have am? no, no
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 27, 0
		// Real offset of type is 27, isauto 0
						// (prepobj r0)
 						// (prepobj r0)
 						// matchobj comparing flags 82 with 1
						// matchobj comparing flags 82 with 82
	...
	stbinc	r0
		...
		// Real offset of type is 32, isauto 0
						// (prepobj r0)
 						...
 						// matchobj comparing flags 82 with 1
						// matchobj comparing flags 82 with 82
						//auto: flags: 82, comparing 0, 32 with 0, 28
